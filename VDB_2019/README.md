...
GetAscendFromTaxID<-function(taxids) {
  ...
  while(i<=length(taxids)) {
    ...
    url<-paste("http://lifemap-ncbi.univ-lyon1.fr/solr/addi/select?q=taxid:(",taxids_sub,")&wt=json&rows=1000",sep="", collapse="")
    #do the request :
